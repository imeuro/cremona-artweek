		...
		CAWdata => {
			...
			if (itemID == 12 || itemID == 76) {  
				...
				Object.values(CAWdata).forEach(el => {
					...
					!("evento_location" in el.acf || "street_number" in el.acf.evento_location) ? el.acf.evento_location.street_number = 's/n' : el.acf.evento_location.street_number = el.acf.evento_location.street_number;
