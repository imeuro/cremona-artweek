...
function caw_2023_scripts() {
    ...
    wp_enqueue_style( 'caw_2023-style-custom', get_template_directory_uri() . '/caw.css', array(), _S_VERSION );
	wp_style_add_data( 'caw_2023-style', 'rtl', 'replace' );

	wp_enqueue_script( 'caw_2023-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
