...
<head>
	...
	<link rel="apple-touch-icon" sizes="180x180" href="<?php echo get_template_directory_uri(); ?>/assets/graphics/favicons/apple-touch-icon.png?v=2024">
	<link rel="icon" type="image/png" sizes="32x32" href="<?php echo get_template_directory_uri(); ?>/assets/graphics/favicons/favicon-32x32.png?v=2024">
	<link rel="icon" type="image/png" sizes="16x16" href="<?php echo get_template_directory_uri(); ?>/assets/graphics/favicons/favicon-16x16.png?v=2024">
	<link rel="manifest" href="<?php echo get_template_directory_uri(); ?>/assets/graphics/favicons/site.webmanifest?v=2024">
	<link rel="mask-icon" href="<?php echo get_template_directory_uri(); ?>/assets/graphics/favicons/safari-pinned-tab.svg?v=2024" color="#ff0000">
	<link rel="shortcut icon" href="<?php echo get_template_directory_uri(); ?>/assets/graphics/favicons/favicon.ico?v=2024">
